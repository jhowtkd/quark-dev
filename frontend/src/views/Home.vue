<template>
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/your-org/quark" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="/icon.png" alt="Quark Logo" class="hero-logo" />
          </div>
