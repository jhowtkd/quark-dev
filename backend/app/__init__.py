# Quark Backend - Flask Application Factory
# -*- coding: utf-8 -*-
"""
...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("Quark Backend starting...")
        logger.info("=" * 50)
    ...
    @app.before_request
    def log_request():
        logger = get_logger('quark.request')
    ...
    @app.route('/health')
    def health():
        return {'status': 'ok', 'service': 'Quark Backend'}
    
    if should_log_startup:
        logger.info("Quark Backend started successfully")
